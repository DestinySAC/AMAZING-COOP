...
Action OnRecoilTakeDamage(int victim, int &attacker, int &inflictor, float &damage, int &damagetype)
{
	if (MT_IsCorePluginEnabled() && bIsValidClient(victim, MT_CHECK_INDEX|MT_CHECK_INGAME|MT_CHECK_ALIVE) && damage > 0.0)
	{
		...
		{
			if ((!MT_HasAdminAccess(attacker) && !bHasAdminAccess(attacker, g_esRecoilAbility[g_esRecoilPlayer[attacker].g_iTankTypeRecorded].g_iAccessFlags, g_esRecoilPlayer[attacker].g_iAccessFlags)) || MT_IsAdminImmune(victim, attacker) || bIsAdminImmune(victim, g_esRecoilPlayer[attacker].g_iTankType, g_esRecoilAbility[g_esRecoilPlayer[attacker].g_iTankTypeRecorded].g_iImmunityFlags, g_esRecoilPlayer[victim].g_iImmunityFlags))
			{
		...
		{
			if ((!MT_HasAdminAccess(victim) && !bHasAdminAccess(victim, g_esRecoilAbility[g_esRecoilPlayer[victim].g_iTankTypeRecorded].g_iAccessFlags, g_esRecoilPlayer[victim].g_iAccessFlags)) || MT_IsAdminImmune(attacker, victim) || bIsAdminImmune(attacker, g_esRecoilPlayer[victim].g_iTankType, g_esRecoilAbility[g_esRecoilPlayer[victim].g_iTankTypeRecorded].g_iImmunityFlags, g_esRecoilPlayer[attacker].g_iImmunityFlags))
			{
				return Plugin_Continue;
			}
...
#endif
{
	if (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility != 2)
	{
		return;
	}
...
#endif
{
	switch (mode)
	{
		...
		case 3:
		{
			for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
			{
				g_esRecoilPlayer[iPlayer].g_iAccessFlags = -1;
				g_esRecoilPlayer[iPlayer].g_iImmunityFlags = -1;
				g_esRecoilPlayer[iPlayer].g_flCloseAreasOnly = -1.0;
				g_esRecoilPlayer[iPlayer].g_iComboAbility = -1;
				g_esRecoilPlayer[iPlayer].g_iHumanAbility = -1;
				g_esRecoilPlayer[iPlayer].g_iHumanAmmo = -1;
				g_esRecoilPlayer[iPlayer].g_iHumanCooldown = -1;
				g_esRecoilPlayer[iPlayer].g_iHumanRangeCooldown = -1;
				g_esRecoilPlayer[iPlayer].g_flOpenAreasOnly = -1.0;
				g_esRecoilPlayer[iPlayer].g_iRequiresHumans = -1;
				g_esRecoilPlayer[iPlayer].g_iRecoilAbility = -1;
				g_esRecoilPlayer[iPlayer].g_iRecoilEffect = -1;
				g_esRecoilPlayer[iPlayer].g_iRecoilMessage = -1;
				g_esRecoilPlayer[iPlayer].g_flRecoilChance = -1.0;
				g_esRecoilPlayer[iPlayer].g_iRecoilCooldown = -1;
				g_esRecoilPlayer[iPlayer].g_flRecoilDuration = -1.0;
				g_esRecoilPlayer[iPlayer].g_iRecoilHit = -1;
				g_esRecoilPlayer[iPlayer].g_iRecoilHitMode = -1;
				g_esRecoilPlayer[iPlayer].g_flRecoilRange = -1.0;
				g_esRecoilPlayer[iPlayer].g_flRecoilRangeChance = -1.0;
...
#endif
{
	if ((mode == -1 || mode == 3) && bIsValidClient(admin))
	{
		...
		{
			g_esRecoilPlayer[admin].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esRecoilPlayer[admin].g_flCloseAreasOnly, value, -1.0, 99999.0);
			g_esRecoilPlayer[admin].g_iComboAbility = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esRecoilPlayer[admin].g_iComboAbility, value, -1, 1);
			g_esRecoilPlayer[admin].g_iHumanAbility = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esRecoilPlayer[admin].g_iHumanAbility, value, -1, 2);
			g_esRecoilPlayer[admin].g_iHumanAmmo = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esRecoilPlayer[admin].g_iHumanAmmo, value, -1, 99999);
			g_esRecoilPlayer[admin].g_iHumanCooldown = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esRecoilPlayer[admin].g_iHumanCooldown, value, -1, 99999);
			g_esRecoilPlayer[admin].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esRecoilPlayer[admin].g_iHumanRangeCooldown, value, -1, 99999);
			g_esRecoilPlayer[admin].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esRecoilPlayer[admin].g_flOpenAreasOnly, value, -1.0, 99999.0);
			g_esRecoilPlayer[admin].g_iRequiresHumans = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esRecoilPlayer[admin].g_iRequiresHumans, value, -1, 32);
			...
			g_esRecoilPlayer[admin].g_iRecoilHit = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilHit", "Recoil Hit", "Recoil_Hit", "hit", g_esRecoilPlayer[admin].g_iRecoilHit, value, -1, 1);
			g_esRecoilPlayer[admin].g_iRecoilHitMode = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilHitMode", "Recoil Hit Mode", "Recoil_Hit_Mode", "hitmode", g_esRecoilPlayer[admin].g_iRecoilHitMode, value, -1, 2);
			...
			g_esRecoilPlayer[admin].g_flRecoilRangeChance = flGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilRangeChance", "Recoil Range Chance", "Recoil_Range_Chance", "rangechance", g_esRecoilPlayer[admin].g_flRecoilRangeChance, value, -1.0, 100.0);
			g_esRecoilPlayer[admin].g_iRecoilRangeCooldown = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilRangeCooldown", "Recoil Range Cooldown", "Recoil_Range_Cooldown", "rangecooldown", g_esRecoilPlayer[admin].g_iRecoilRangeCooldown, value, -1, 99999);
	...
	if (mode < 3 && type > 0)
	{
		...
		{
			g_esRecoilAbility[type].g_flCloseAreasOnly = flGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "CloseAreasOnly", "Close Areas Only", "Close_Areas_Only", "closeareas", g_esRecoilAbility[type].g_flCloseAreasOnly, value, -1.0, 99999.0);
			g_esRecoilAbility[type].g_iComboAbility = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "ComboAbility", "Combo Ability", "Combo_Ability", "combo", g_esRecoilAbility[type].g_iComboAbility, value, -1, 1);
			g_esRecoilAbility[type].g_iHumanAbility = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanAbility", "Human Ability", "Human_Ability", "human", g_esRecoilAbility[type].g_iHumanAbility, value, -1, 2);
			g_esRecoilAbility[type].g_iHumanAmmo = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanAmmo", "Human Ammo", "Human_Ammo", "hammo", g_esRecoilAbility[type].g_iHumanAmmo, value, -1, 99999);
			g_esRecoilAbility[type].g_iHumanCooldown = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanCooldown", "Human Cooldown", "Human_Cooldown", "hcooldown", g_esRecoilAbility[type].g_iHumanCooldown, value, -1, 99999);
			g_esRecoilAbility[type].g_iHumanRangeCooldown = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "HumanRangeCooldown", "Human Range Cooldown", "Human_Range_Cooldown", "hrangecooldown", g_esRecoilAbility[type].g_iHumanRangeCooldown, value, -1, 99999);
			g_esRecoilAbility[type].g_flOpenAreasOnly = flGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "OpenAreasOnly", "Open Areas Only", "Open_Areas_Only", "openareas", g_esRecoilAbility[type].g_flOpenAreasOnly, value, -1.0, 99999.0);
			g_esRecoilAbility[type].g_iRequiresHumans = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RequiresHumans", "Requires Humans", "Requires_Humans", "hrequire", g_esRecoilAbility[type].g_iRequiresHumans, value, -1, 32);
			...
			g_esRecoilAbility[type].g_iRecoilHit = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilHit", "Recoil Hit", "Recoil_Hit", "hit", g_esRecoilAbility[type].g_iRecoilHit, value, -1, 1);
			g_esRecoilAbility[type].g_iRecoilHitMode = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilHitMode", "Recoil Hit Mode", "Recoil_Hit_Mode", "hitmode", g_esRecoilAbility[type].g_iRecoilHitMode, value, -1, 2);
			...
			g_esRecoilAbility[type].g_flRecoilRangeChance = flGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilRangeChance", "Recoil Range Chance", "Recoil_Range_Chance", "rangechance", g_esRecoilAbility[type].g_flRecoilRangeChance, value, -1.0, 100.0);
			g_esRecoilAbility[type].g_iRecoilRangeCooldown = iGetKeyValue(subsection, MT_RECOIL_SECTION, MT_RECOIL_SECTION2, MT_RECOIL_SECTION3, MT_RECOIL_SECTION4, key, "RecoilRangeCooldown", "Recoil Range Cooldown", "Recoil_Range_Cooldown", "rangecooldown", g_esRecoilAbility[type].g_iRecoilRangeCooldown, value, -1, 99999);
...
#endif
{
	...
	g_esRecoilPlayer[tank].g_iTankTypeRecorded = apply ? MT_GetRecordedTankType(tank, type) : 0;
	g_esRecoilPlayer[tank].g_iTankType = apply ? type : 0;
	int iType = g_esRecoilPlayer[tank].g_iTankTypeRecorded;

	if (bIsSpecialInfected(tank, MT_CHECK_INDEX|MT_CHECK_INGAME))
	{
		g_esRecoilCache[tank].g_flCloseAreasOnly = flGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_flCloseAreasOnly, g_esRecoilPlayer[tank].g_flCloseAreasOnly, g_esRecoilSpecial[iType].g_flCloseAreasOnly, g_esRecoilAbility[iType].g_flCloseAreasOnly, 1);
		g_esRecoilCache[tank].g_iComboAbility = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iComboAbility, g_esRecoilPlayer[tank].g_iComboAbility, g_esRecoilSpecial[iType].g_iComboAbility, g_esRecoilAbility[iType].g_iComboAbility, 1);
		g_esRecoilCache[tank].g_flRecoilChance = flGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_flRecoilChance, g_esRecoilPlayer[tank].g_flRecoilChance, g_esRecoilSpecial[iType].g_flRecoilChance, g_esRecoilAbility[iType].g_flRecoilChance, 1);
		g_esRecoilCache[tank].g_flRecoilDuration = flGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_flRecoilDuration, g_esRecoilPlayer[tank].g_flRecoilDuration, g_esRecoilSpecial[iType].g_flRecoilDuration, g_esRecoilAbility[iType].g_flRecoilDuration, 1);
		g_esRecoilCache[tank].g_flRecoilRange = flGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_flRecoilRange, g_esRecoilPlayer[tank].g_flRecoilRange, g_esRecoilSpecial[iType].g_flRecoilRange, g_esRecoilAbility[iType].g_flRecoilRange, 1);
		g_esRecoilCache[tank].g_flRecoilRangeChance = flGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_flRecoilRangeChance, g_esRecoilPlayer[tank].g_flRecoilRangeChance, g_esRecoilSpecial[iType].g_flRecoilRangeChance, g_esRecoilAbility[iType].g_flRecoilRangeChance, 1);
		g_esRecoilCache[tank].g_iHumanAbility = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iHumanAbility, g_esRecoilPlayer[tank].g_iHumanAbility, g_esRecoilSpecial[iType].g_iHumanAbility, g_esRecoilAbility[iType].g_iHumanAbility, 1);
		g_esRecoilCache[tank].g_iHumanAmmo = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iHumanAmmo, g_esRecoilPlayer[tank].g_iHumanAmmo, g_esRecoilSpecial[iType].g_iHumanAmmo, g_esRecoilAbility[iType].g_iHumanAmmo, 1);
		g_esRecoilCache[tank].g_iHumanCooldown = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iHumanCooldown, g_esRecoilPlayer[tank].g_iHumanCooldown, g_esRecoilSpecial[iType].g_iHumanCooldown, g_esRecoilAbility[iType].g_iHumanCooldown, 1);
		g_esRecoilCache[tank].g_iHumanRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iHumanRangeCooldown, g_esRecoilPlayer[tank].g_iHumanRangeCooldown, g_esRecoilSpecial[iType].g_iHumanRangeCooldown, g_esRecoilAbility[iType].g_iHumanRangeCooldown, 1);
		g_esRecoilCache[tank].g_iRecoilAbility = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilAbility, g_esRecoilPlayer[tank].g_iRecoilAbility, g_esRecoilSpecial[iType].g_iRecoilAbility, g_esRecoilAbility[iType].g_iRecoilAbility, 1);
		g_esRecoilCache[tank].g_iRecoilCooldown = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilCooldown, g_esRecoilPlayer[tank].g_iRecoilCooldown, g_esRecoilSpecial[iType].g_iRecoilCooldown, g_esRecoilAbility[iType].g_iRecoilCooldown, 1);
		g_esRecoilCache[tank].g_iRecoilEffect = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilEffect, g_esRecoilPlayer[tank].g_iRecoilEffect, g_esRecoilSpecial[iType].g_iRecoilEffect, g_esRecoilAbility[iType].g_iRecoilEffect, 1);
		g_esRecoilCache[tank].g_iRecoilHit = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilHit, g_esRecoilPlayer[tank].g_iRecoilHit, g_esRecoilSpecial[iType].g_iRecoilHit, g_esRecoilAbility[iType].g_iRecoilHit, 1);
		g_esRecoilCache[tank].g_iRecoilHitMode = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilHitMode, g_esRecoilPlayer[tank].g_iRecoilHitMode, g_esRecoilSpecial[iType].g_iRecoilHitMode, g_esRecoilAbility[iType].g_iRecoilHitMode, 1);
		g_esRecoilCache[tank].g_iRecoilMessage = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilMessage, g_esRecoilPlayer[tank].g_iRecoilMessage, g_esRecoilSpecial[iType].g_iRecoilMessage, g_esRecoilAbility[iType].g_iRecoilMessage, 1);
		g_esRecoilCache[tank].g_iRecoilRangeCooldown = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilRangeCooldown, g_esRecoilPlayer[tank].g_iRecoilRangeCooldown, g_esRecoilSpecial[iType].g_iRecoilRangeCooldown, g_esRecoilAbility[iType].g_iRecoilRangeCooldown, 1);
		g_esRecoilCache[tank].g_iRecoilSight = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRecoilSight, g_esRecoilPlayer[tank].g_iRecoilSight, g_esRecoilSpecial[iType].g_iRecoilSight, g_esRecoilAbility[iType].g_iRecoilSight, 1);
		g_esRecoilCache[tank].g_flOpenAreasOnly = flGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_flOpenAreasOnly, g_esRecoilPlayer[tank].g_flOpenAreasOnly, g_esRecoilSpecial[iType].g_flOpenAreasOnly, g_esRecoilAbility[iType].g_flOpenAreasOnly, 1);
		g_esRecoilCache[tank].g_iRequiresHumans = iGetSubSettingValue(apply, bHuman, g_esRecoilTeammate[tank].g_iRequiresHumans, g_esRecoilPlayer[tank].g_iRequiresHumans, g_esRecoilSpecial[iType].g_iRequiresHumans, g_esRecoilAbility[iType].g_iRequiresHumans, 1);
	}
	else
	{
		g_esRecoilCache[tank].g_flCloseAreasOnly = flGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_flCloseAreasOnly, g_esRecoilAbility[iType].g_flCloseAreasOnly, 1);
		g_esRecoilCache[tank].g_iComboAbility = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iComboAbility, g_esRecoilAbility[iType].g_iComboAbility, 1);
		g_esRecoilCache[tank].g_flRecoilChance = flGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_flRecoilChance, g_esRecoilAbility[iType].g_flRecoilChance, 1);
		g_esRecoilCache[tank].g_flRecoilDuration = flGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_flRecoilDuration, g_esRecoilAbility[iType].g_flRecoilDuration, 1);
		g_esRecoilCache[tank].g_flRecoilRange = flGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_flRecoilRange, g_esRecoilAbility[iType].g_flRecoilRange, 1);
		g_esRecoilCache[tank].g_flRecoilRangeChance = flGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_flRecoilRangeChance, g_esRecoilAbility[iType].g_flRecoilRangeChance, 1);
		g_esRecoilCache[tank].g_iHumanAbility = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iHumanAbility, g_esRecoilAbility[iType].g_iHumanAbility, 1);
		g_esRecoilCache[tank].g_iHumanAmmo = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iHumanAmmo, g_esRecoilAbility[iType].g_iHumanAmmo, 1);
		g_esRecoilCache[tank].g_iHumanCooldown = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iHumanCooldown, g_esRecoilAbility[iType].g_iHumanCooldown, 1);
		g_esRecoilCache[tank].g_iHumanRangeCooldown = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iHumanRangeCooldown, g_esRecoilAbility[iType].g_iHumanRangeCooldown, 1);
		g_esRecoilCache[tank].g_iRecoilAbility = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilAbility, g_esRecoilAbility[iType].g_iRecoilAbility, 1);
		g_esRecoilCache[tank].g_iRecoilCooldown = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilCooldown, g_esRecoilAbility[iType].g_iRecoilCooldown, 1);
		g_esRecoilCache[tank].g_iRecoilEffect = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilEffect, g_esRecoilAbility[iType].g_iRecoilEffect, 1);
		g_esRecoilCache[tank].g_iRecoilHit = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilHit, g_esRecoilAbility[iType].g_iRecoilHit, 1);
		g_esRecoilCache[tank].g_iRecoilHitMode = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilHitMode, g_esRecoilAbility[iType].g_iRecoilHitMode, 1);
		g_esRecoilCache[tank].g_iRecoilMessage = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilMessage, g_esRecoilAbility[iType].g_iRecoilMessage, 1);
		g_esRecoilCache[tank].g_iRecoilRangeCooldown = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilRangeCooldown, g_esRecoilAbility[iType].g_iRecoilRangeCooldown, 1);
		g_esRecoilCache[tank].g_iRecoilSight = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRecoilSight, g_esRecoilAbility[iType].g_iRecoilSight, 1);
		g_esRecoilCache[tank].g_flOpenAreasOnly = flGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_flOpenAreasOnly, g_esRecoilAbility[iType].g_flOpenAreasOnly, 1);
		g_esRecoilCache[tank].g_iRequiresHumans = iGetSettingValue(apply, bHuman, g_esRecoilPlayer[tank].g_iRequiresHumans, g_esRecoilAbility[iType].g_iRequiresHumans, 1);
	}
}
...
#endif
{
	if (MT_IsTankSupported(tank, MT_CHECK_INDEX|MT_CHECK_INGAME|MT_CHECK_FAKECLIENT) && ((!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esRecoilAbility[g_esRecoilPlayer[tank].g_iTankTypeRecorded].g_iAccessFlags, g_esRecoilPlayer[tank].g_iAccessFlags)) || g_esRecoilCache[tank].g_iHumanAbility == 0))
	{
		return;
	}

	if (MT_IsTankSupported(tank) && (!bIsInfected(tank, MT_CHECK_FAKECLIENT) || g_esRecoilCache[tank].g_iHumanAbility != 1) && MT_IsCustomTankSupported(tank) && g_esRecoilCache[tank].g_iRecoilAbility == 1 && g_esRecoilCache[tank].g_iComboAbility == 0)
	{
...
#endif
{
	...
	{
		if (bIsAreaNarrow(tank, g_esRecoilCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esRecoilCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esRecoilPlayer[tank].g_iTankType, tank) || (g_esRecoilCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esRecoilCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esRecoilAbility[g_esRecoilPlayer[tank].g_iTankTypeRecorded].g_iAccessFlags, g_esRecoilPlayer[tank].g_iAccessFlags)))
		{
			return;
		}
...
void vRecoilAbility(int tank, float random, int pos = -1)
{
	...
	if (!bIsInfected(tank, MT_CHECK_FAKECLIENT) || (g_esRecoilPlayer[tank].g_iAmmoCount < g_esRecoilCache[tank].g_iHumanAmmo && g_esRecoilCache[tank].g_iHumanAmmo > 0))
	{
		...
		{
			if (bIsSurvivor(iSurvivor, MT_CHECK_INGAME|MT_CHECK_ALIVE) && !MT_IsAdminImmune(iSurvivor, tank) && !bIsAdminImmune(iSurvivor, g_esRecoilPlayer[tank].g_iTankType, g_esRecoilAbility[g_esRecoilPlayer[tank].g_iTankTypeRecorded].g_iImmunityFlags, g_esRecoilPlayer[iSurvivor].g_iImmunityFlags))
			{
				GetClientAbsOrigin(iSurvivor, flSurvivorPos);
				if (GetVectorDistance(flTankPos, flSurvivorPos) <= flRange && bIsVisibleToPlayer(tank, iSurvivor, g_esRecoilCache[tank].g_iRecoilSight, .range = flRange))
				{
		...
		if (iSurvivorCount == 0)
		{
			if (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility == 1)
			{
				//MT_PrintToChat(tank, "%s %t", MT_TAG3, "RecoilHuman4");
			}
		}
	}
	else if (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility == 1)
	{
...
{
	if (bIsAreaNarrow(tank, g_esRecoilCache[tank].g_flOpenAreasOnly) || bIsAreaWide(tank, g_esRecoilCache[tank].g_flCloseAreasOnly) || MT_DoesTypeRequireHumans(g_esRecoilPlayer[tank].g_iTankType, tank) || (g_esRecoilCache[tank].g_iRequiresHumans > 0 && iGetHumanCount() < g_esRecoilCache[tank].g_iRequiresHumans) || (!MT_HasAdminAccess(tank) && !bHasAdminAccess(tank, g_esRecoilAbility[g_esRecoilPlayer[tank].g_iTankTypeRecorded].g_iAccessFlags, g_esRecoilPlayer[tank].g_iAccessFlags)) || MT_IsAdminImmune(survivor, tank) || bIsAdminImmune(survivor, g_esRecoilPlayer[tank].g_iTankType, g_esRecoilAbility[g_esRecoilPlayer[tank].g_iTankTypeRecorded].g_iImmunityFlags, g_esRecoilPlayer[survivor].g_iImmunityFlags))
	{
		return;
	}
	...
	{
		if (!bIsInfected(tank, MT_CHECK_FAKECLIENT) || (flags & MT_ATTACK_CLAW) || (flags & MT_ATTACK_MELEE) || (g_esRecoilPlayer[tank].g_iAmmoCount < g_esRecoilCache[tank].g_iHumanAmmo && g_esRecoilCache[tank].g_iHumanAmmo > 0))
		{
			if (random <= chance && !g_esRecoilPlayer[survivor].g_bAffected)
			{
				...
				if ((flags & MT_ATTACK_RANGE) && (g_esRecoilPlayer[tank].g_iRangeCooldown == -1 || g_esRecoilPlayer[tank].g_iRangeCooldown <= iTime))
				{
					...
					iCooldown = (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility == 1 && g_esRecoilPlayer[tank].g_iAmmoCount < g_esRecoilCache[tank].g_iHumanAmmo && g_esRecoilCache[tank].g_iHumanAmmo > 0) ? g_esRecoilCache[tank].g_iHumanRangeCooldown : iCooldown;
				...
				else if (((flags & MT_ATTACK_CLAW) || (flags & MT_ATTACK_MELEE)) && (g_esRecoilPlayer[tank].g_iCooldown == -1 || g_esRecoilPlayer[tank].g_iCooldown <= iTime))
				{
					...
					iCooldown = (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility == 1) ? g_esRecoilCache[tank].g_iHumanCooldown : iCooldown;
			...
			{
				if (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility == 1 && !g_esRecoilPlayer[tank].g_bFailed)
				{
		...
		else if (bIsInfected(tank, MT_CHECK_FAKECLIENT) && g_esRecoilCache[tank].g_iHumanAbility == 1 && !g_esRecoilPlayer[tank].g_bNoAmmo)
		{
...
void vRemoveRecoil(int tank)
{
	for (int iSurvivor = 1; iSurvivor <= MaxClients; iSurvivor++)
	{
		if (bIsSurvivor(iSurvivor, MT_CHECK_INGAME) && g_esRecoilPlayer[iSurvivor].g_bAffected && g_esRecoilPlayer[iSurvivor].g_iOwner == tank)
		{
			...
			g_esRecoilPlayer[iSurvivor].g_iOwner = -1;
		}
	}
...
void vRecoilReset()
{
	for (int iPlayer = 1; iPlayer <= MaxClients; iPlayer++)
	{
		if (bIsValidClient(iPlayer, MT_CHECK_INGAME))
		{
			...
			g_esRecoilPlayer[iPlayer].g_iOwner = -1;
		}
	}
}
...
void tTimerRecoilCombo2(Handle timer, DataPack pack)
{
	...
	int iTank = GetClientOfUserId(pack.ReadCell());
	if (!MT_IsCorePluginEnabled() || !MT_IsTankSupported(iTank) || (!MT_HasAdminAccess(iTank) && !bHasAdminAccess(iTank, g_esRecoilAbility[g_esRecoilPlayer[iTank].g_iTankTypeRecorded].g_iAccessFlags, g_esRecoilPlayer[iTank].g_iAccessFlags)) || !MT_IsTypeEnabled(g_esRecoilPlayer[iTank].g_iTankType, iTank) || !MT_IsCustomTankSupported(iTank) || g_esRecoilCache[iTank].g_iRecoilHit == 0)
	{
		return;
	}
	...
	if ((g_esRecoilCache[iTank].g_iRecoilHitMode == 0 || g_esRecoilCache[iTank].g_iRecoilHitMode == 1) && (bIsSpecialInfected(iTank) || StrEqual(sClassname[7], "tank_claw") || StrEqual(sClassname, "tank_rock")))
	{
